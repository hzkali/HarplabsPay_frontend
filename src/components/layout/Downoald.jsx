        ...
        <div className="md:grid grid-cols-[1fr_10fr_1fr]">
          ...
          <div className="flex flex-col gap-10">
            <h2 className="lg:text-[52px] md:text-5xl text-3xl">
              Get the HarplabsPay App and <br /> Dive Into Crypto
            </h2>
            ...
            <div className="flex flex-col gap-6">
              ...
              <Banner
                ...
                text={
                  "Unlock the power of crypto on the go with the HarplabsPay app. Seamlessly manage, trade, and track your digital assets from the palm of your hand, wherever you are. Download now and take control of your crypto."
                }
                srcImg={Mockup_Earn}
                imgStyle={
