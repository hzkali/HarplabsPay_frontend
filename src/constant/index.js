...
const testimonials = [
  {
    ...
    content: "HarplabsPay has completely transformed my crypto experience. With their user-friendly interface and top-notch security features,I feel confident managing my investments.I couldn't be happier with my decision to trust HarplabsPay with my digital assets.",
    date: "Apr 1, 2024"
  },
  {
    img: Image_2,
    name: "Michael Smith",
    account: "@msmith",
    content: "I've tried several crypto platforms in the past, but none compare to HarplabsPay. The platform's security measures give me peace of mind knowing that my assets are safe. Plus, the intuitive design makes it easy for me to navigate and execute transactions.",
    date: "Mar 24, 2024"
  },
  {
    img: Image_3,
    name: "Emily Chen",
    account: "@e.chen",
    content: "HarplabsPay has exceeded all my expectations. Customer support is excellent. Whenever I've had an issue or a question, the support team has been quick to respond and incredibly helpful. HarplabsPay has made managing my crypto portfolio a breeze.",
    date: "Mar 16, 2024"
  }
];
...
const questions = [
  {
    question: "Is my personal information safe with HarplabsPay?",
    response: "Absolutely. At HarplabsPay, we take the security and privacy of our users' personal information very seriously. We employ advanced encryption techniques to protect your data and adhere to strict security protocols to ensure it remains confidential at all times.",
    id: "first"
  },
  {
    question: "What cryptocurrencies does HarplabsPay support?",
    response: "HarplabsPay supports a wide range of cryptocurrencies, including Bitcoin (BTC), Ethereum (ETH), Litecoin (LTC), Ripple (XRP), and many more. You can find a full list of supported cryptocurrencies in your HarplabsPay account dashboard.",
    id: "second"
  },
  {
    question: "How can I deposit funds into my HarplabsPay account?",
    response: "To deposit funds into your HarplabsPay account, simply navigate to the 'Receive' section of your account dashboard and follow the instructions provided. You can deposit funds using various methods, including bank transfers, credit/debit cards, and cryptocurrency transfers.",
    id: "third"
  },
  {
    question: "Can I withdraw my funds from HarplabsPay at any time?",
    response: 'Yes, you can withdraw your funds from HarplabsPay at any time. Simply navigate to the "Send" section of your account dashboard, select the desired withdrawal method, and follow the prompts to initiate the withdrawal process. Please note that withdrawal processing times may vary depending on the chosen method.',
    id: "foorth"
  },
  {
    question: "Does HarplabsPay charge any fees for transactions?",
    response: 'HarplabsPay may charge fees for certain transactions, such as deposits, withdrawals, and trades. These fees help cover the costs associated with maintaining our platform and providing you with the best possible service. You can find detailed information about our fees in the "Fees" section of your account dashboard.',
    id: "fifth"
  },
  {
    question: "Can I use HarplabsPay on my mobile device?",
    response: 'Yes, HarplabsPay is fully compatible with mobile devices. You can access our platform through your mobile browser or download our mobile app from the App Store or Google Play Store. With HarplabsPay mobile, you can manage your investments and stay connected to the crypto market on the go.',
    id: "sixth"
  },
];
...
const downoalds = [
  {
    ...
    content: "Download the HarplabsPay Wallet Mobile App from the App Store."
  },
  {
    img: Android,
    title: "Download for Android",
    content: "Download the HarplabsPay Wallet Mobile App from the Google Play."
  },
  {
    img: Chrome,
...
const supports = [
  {
    ...
    href: "mailto:token@harplabs.co.uk?subject=Hello!"
  },
  {
    img: Discord,
    title: "Twitter Community",
    content: "Join our lively Twitter Community for crypto insights, updates, and support.",
    href: "https://twitter.com/harplabs_uk",
...
const footerLinks = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "https://play.google.com/store/apps/details?id=com.harplabspay&hl=en&gl=US", label: "Android App" },
  ...
  },
  {
    ...
    title: "RESOURCES",
    links: [
      { href: "https://www.harplabspay.com", label: "Whitepaper" },
      { href: "https://www.google.com", label: "Developer Portal" },
      { href: "https://www.harplabs.co.uk", label: "HarplabsPay Foundation" }
    ]
  },
  {
    type: "without",
    title: "SUPPORT",
    links: [
      { href: "mailto:token@harplabs.co.uk?subject=Hello!", label: "General Support" },
      { href: "https://twitter.com/harplabs_uk", label: "Twitter Community" },
      { href: "https://t.me/harplabs", label: "Telegram Chat" }
    ]
  },
];
